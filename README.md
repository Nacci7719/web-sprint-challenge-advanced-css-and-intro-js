...
1. How would you describe acessibility on the web to someone new to programming?
    ...
    ~ Web accessibility means that websites or other technologies are designed and developed so that people with disabilities can use them. 

2. Talk about 3 different things you can do to ensure your website is accessible.

    a. Write semantic HTML
    b. Choose colors carefully
    c. Enable Resizeable Text

3. How would you explain the concept of a variable to someone new to programming?

    ~ Varaibles are storage containers that hold different types of data.

4. What is the purpose of using functions in code?

    ~ Functions are like mini apps that perform certain actions and are important for reusing code.
